...
const SingleRecipe = () => {
  ...
  return recipe ? (
    <div>
      <div className="absolute text-4xl sm:text-4xl font-bold text-red-400 p-10 cursor-pointer">
        {favorite.find((f) => f.id == recipe?.id) ? (
          <span
            onClick={UnFavHandler}
            className="absolute text-red-400 transition-opacity duration-300"
          >
            &#9829;
          </span>
        ) : (
